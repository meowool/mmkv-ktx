...
internal const val WRITE_ONLY = "This property is write-only and cannot be read."
internal val UNCHANGED = object {}

internal fun <T> Any?.takeIfChanged(): T? =
  if (this === UNCHANGED) null else this as T
